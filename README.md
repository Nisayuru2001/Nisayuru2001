...
- 🔧 **AutoSched Project** – Leveraging the MERN stack for innovative scheduling solutions.
- 📚 Deepening my knowledge of **Oracle** and object-relational database systems.
- 🌱 Expanding my skills with emerging technologies and modern development practices.

## 👨‍💻 About Me
- 🚀 **Full Stack Developer** with a passion for building robust, scalable solutions.
- 🌍 Based in **Sri Lanka** 🇱🇰, known in the dev community as **"Kavi"**.
- 🎓 Currently studying **Computer Science**, focusing on **Advanced Database Concepts**.
- 💡 Key Interests: **Software Architecture, Cloud Computing, AI/ML**.
- 🔥 My life motto: *Code with passion, debug with patience ⚡*.
- 🏆 Always eager to push the boundaries of what's possible through code.
